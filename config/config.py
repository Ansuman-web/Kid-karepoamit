...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Aurbin3555")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Ansuman-web/Kid-karepoamit.git",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/aurbinmusicsupport_group")
